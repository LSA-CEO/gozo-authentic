...
export function Footer({ locale }: FooterProps) {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: 'https://facebook.com/gozoauthentic',
      icon: (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/gozoauthentic',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/gozoauthentic',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href={`/${locale}/experiences`} className="text-gray-400 hover:text-white transition-colors">
                  {t('experiences')}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/${locale}/carnet`} className="text-gray-400 hover:text-white transition-colors">
                  {t('myCarnet')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:hello@gozoauthentic.com" className="hover:text-white transition-colors">
                  hello@gozoauthentic.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/35699999999" className="hover:text-white transition-colors">
                  WhatsApp
                </a>
              </li>
            </ul>
